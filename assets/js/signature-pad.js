  ...
  class i extends EventTarget {
    ...
    _strokeUpdate(t) {
      ...
      const e = t.clientX,
        i = t.clientY,
        n =
          void 0 !== t.pressure ? t.pressure : void 0 !== t.force ? t.force : 0,
      ...
      if (!r || !r || !a) {
        ...
        r
          ...
          h.push({ time: s.time, x: s.x, y: s.y, pressure: s.pressure })
      }
      ...
      for (const s of e) {
        ...
        if (a.length > 1)
          for (let n = 0; n < a.length; n += 1) {
            ...
            l && i(l, { penColor: e, dotSize: o, minWidth: h, maxWidth: r })
          }
        else
          this._reset(),
            n(a[0], { penColor: e, dotSize: o, minWidth: h, maxWidth: r })
      }
    }
    _toSVG() {
      const t = this._data,
      ...
      s.setAttribute('width', this.canvas.width.toString()),
        ...
        this._fromData(
          ...
          (t, { penColor: e, dotSize: i, minWidth: n, maxWidth: o }) => {
